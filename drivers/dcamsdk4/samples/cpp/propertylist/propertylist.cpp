/**
 ...
 @brief		sample code to get the list of property that the camera supports.
 @detail	This program shows the list of property that the camera supports. The shown information is added by the directives.
 ...
 */
#define SHOW_PROPERTY_ATTRIBUTE			0	// show the attribute of the property if not 0
 ...
 */
#define SHOW_PROPERTY_MODEVALUELIST		0	// show the value list of mode if not 0
 ...
 *
 */
#define SHOW_PROPERTY_ARRAYELEMENT		0	// show the element of array when the property is base element if not 0.
...
/**
 @brief	show list of property that the camera supports. detail information is shown by the directives.
 @param hdcam:	DCAM handle
 */
