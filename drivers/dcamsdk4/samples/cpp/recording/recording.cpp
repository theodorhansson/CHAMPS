...
#define	USE_USERMETADATA			0	// keep the area to write user meta data(text, binary)
#define STOPCAPTURE_BY_ABORTSIGNAL	0	// 0: stop on recorded specified number, 1: stop by user timing
