/**
 ...
 @brief		sample code to attach buffer to receive imaga data
 @details	This program attaches the buffer to receive image data and accesses the captured image.
...
/**
 ...
 @param pAttachBuf:	pointer array of attached buffer to receive the image
 @param bBufCount:	number of attached buffer
 */
