...
print('Refractive index gold: n = ' + str(round(n, 4)) + '  k = ' + str(round(k, 4)))
...
P_up    = model.evaluate('inline_top(ewfd.Poavy)', dataset=chosen_set)
P_down  = model.evaluate('inline_bot(ewfd.Poavy)', dataset=chosen_set)
P_left  = model.evaluate('inline_left(ewfd.Poavx)', dataset=chosen_set)
P_right = model.evaluate('inline_left(ewfd.Poavx)', dataset=chosen_set)
P_in    = model.evaluate('Pgb', dataset=chosen_set)
