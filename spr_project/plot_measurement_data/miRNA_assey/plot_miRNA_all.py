...
measurements = {'20_5_nM' : {'data_folder': 'spr_measurements_240919', 'measurement_number' : 0, 'concentration' : ['5.0a', '20.0a', 'ref_a'], 'label' : ['5 nM', '20 nM', 'Ref']},
                '0.5_0.05_nM' : {'data_folder': 'spr_measurements_240925', 'measurement_number' : 0, 'concentration' : ['0.05b', '0.5b', 'ref_b'], 'label' : ['50 pM', '0.5 nM', 'Ref']},
                '0.02_0.01_nM_a' : {'data_folder': 'spr_measurements_240925', 'measurement_number' : 1, 'concentration' : ['0.01c', '0.02c', 'ref_c'], 'label' : ['10 pM', '20 pM', 'Ref']},
                '1_0.1_nM': {'data_folder': 'spr_measurements_240925', 'measurement_number' : 2, 'concentration' : ['0.1d', '1.0d', 'ref_c'], 'label' : ['0.1 nM', '1 nM', 'Ref']},
                '0.02_0.01_nM_b': {'data_folder': 'spr_measurements_240925', 'measurement_number' : 3, 'concentration' : ['0.01e', '0.02e', 'ref_e'], 'label' : ['10 pM', '20 pM', 'Ref']},
                ...
                if not re.search('1.0f', conc):
                    if not re.search('5.0', conc):
                        if not re.search('0.1', conc):
                            if not re.search('0.01c', conc):
                                if not re.search('0.02c', conc):
...
all_conc_temp = all_conc
all_conc = [all_conc_temp[3], all_conc_temp[4], all_conc_temp[0], all_conc_temp[1], all_conc_temp[2]]
...
for conc in all_conc:
    ...
    label = conc[:-1]
    plt.plot(selected_time_trace_scaled, spr_0_butter, label=label + r' nM miRNA', linewidth=linewidth_filtered)
...
plt.savefig('miRNA_for_abstract.png', dpi=300)
