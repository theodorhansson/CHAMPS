...
ax.plot(frame_time/MIN, butter_1_theta*1e3, color=colors_bright, label=r'Channel 1', )
ax.plot(frame_time/MIN, butter_2_theta*1e3, color=colors_med, label=r'Channel 2', )
ax.plot(frame_time/MIN, butter_3_theta*1e3, color=colors_dark, label=r'Channel 3', )
