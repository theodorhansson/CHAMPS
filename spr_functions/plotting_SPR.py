...
parent_path = Path(__file__).resolve().parents[1]
names=[
        # '20231212_11.23.24_bsa_ds_attempt_3',
        # '20231212_11.47.07_bsa_ds_attempt_3',
        '20231212_12.19.13_bsa_ds_attempt_3',
        # '20231212_00.17.43_test_spectrum',
       ]


mov_avg_window = 16
VCSEL = ['VCSEL_0', 'VCSEL_1', 'VCSEL_2', 'VCSEL_3', 'VCSEL_4', 'VCSEL_5',]
filename = 'data'
